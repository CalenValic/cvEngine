...
import { meshData, switchCurrentlyEditing, switchEditMode, updateCounts } from "./meshData.js"
...
import { markSeams, removeSeams } from "./seamController.js"
import { straightenUVs } from "./editFunctions.ts/straightenUVs.js"
...
export const addUIElements = async () => {
    ...
    UI.createCheckbox("showMenu", "showSeams", "Seams", "before", (e) => {
        var input = e.target as HTMLInputElement
        meshData.show.seams = input.checked
        saveMeshEditorSettings()
    })
    UI.createCheckbox("showMenu", "showTexture", "Texture", "before", (e) => {
        var input = e.target as HTMLInputElement
        meshData.show.texture = input.checked
        saveMeshEditorSettings()
    })
    ...
    UI.createElement("div", "document", "uvRightClickMenu", "container", {
        styles: {
            display: "none",
            width: "max-content",
            "background-color": "rgb(39, 39, 39)",
    ...
    UI.createHoverMenu("uvRightClickMenu", "uvSelect", "Select")
    UI.createElement("div", "uvSelectHoverMenu", "selectVertices", "defaultText singleLineText defaultButton shortcut", {
        text: "Vertices",
        tags: {
            shortcut: "V"
        },
    ...
    UI.createElement("div", "uvSelectHoverMenu", "selectEdges", "defaultText singleLineText defaultButton shortcut", {
        text: "Edges",
        tags: {
            shortcut: "E"
        },
    ...
    UI.createElement("div", "uvSelectHoverMenu", "selectTriangles", "defaultText singleLineText defaultButton shortcut", {
        text: "Triangles",
        tags: {
            shortcut: "T"
        },
    ...
    UI.createElement("div", "uvSelectHoverMenu", "selectTextureIslands", "defaultText singleLineText defaultButton shortcut", {
        text: "Texture Islands",
        tags: {
            shortcut: "I"
        },
        listeners: {
            click: (e) => {switchEditMode("selectTextureIslands")}
        }
    })
    UI.createElement("div", "uvSelectHoverMenu", "selectAll", "defaultText singleLineText defaultButton shortcut", {
        text: "All",
        tags: {
            shortcut: "Ctrl A"
        },
    ...
    UI.createElement("div", "uvSelectHoverMenu", "clearSelection", "defaultText singleLineText defaultButton shortcut", {
        text: "Clear",
        tags: {
            shortcut: "Esc"
        },
    ...
    UI.createHoverMenu("uvRightClickMenu", "normalUV", "Normals")
    UI.createElement("div", "normalUVHoverMenu", "flipNormalsUV", "defaultText singleLineText defaultButton shortcut", {
        text: "Flip Selected",
        tags: {
            shortcut: "F"
        },
    ...
    UI.createElement("div", "normalUVHoverMenu", "triangleNormalsFaceOutUV", "defaultText singleLineText defaultButton", {
        text: "Face Out",
        listeners: {
            click: (e) => {faceTriangleNormalsOut()}
        }
    })
    UI.createElement("div", "normalUVHoverMenu", "triangleNormalsFaceInUV", "defaultText singleLineText defaultButton", {
        text: "Face In",
        listeners: {
            click: (e) => {faceTriangleNormalsIn()}
        }
    ...
    UI.createHoverMenu("uvRightClickMenu", "uvEdit", "Edit UVs")
    UI.createElement("div", "uvEditHoverMenu", "moveUVs", "defaultText singleLineText defaultButton shortcut", {
        text: "Move",
        tags: {
            shortcut: "M"
        },
        listeners: {
            click: (e) => {switchEditMode("moveUVs")}
        }
    })
    UI.createElement("div", "uvEditHoverMenu", "rotateUVs", "defaultText singleLineText defaultButton shortcut", {
        text: "Rotate",
        tags: {
            shortcut: "R"
        },
        listeners: {
            click: (e) => {switchEditMode("rotateUVs")}
        }
    })
    UI.createElement("div", "uvEditHoverMenu", "scaleUVs", "defaultText singleLineText defaultButton shortcut", {
        text: "Scale",
        tags: {
            shortcut: "C"
        },
        listeners: {
            click: (e) => {switchEditMode("scaleUVs")}
        }
    })
    UI.createElement("div", "uvEditHoverMenu", "straightenXUVs", "defaultText singleLineText defaultButton shortcut", {
        text: "Straighten X",
        tags: {
            shortcut: "X"
        },
        listeners: {
            click: (e) => {straightenUVs()}
        }
    })
    UI.createElement("div", "uvEditHoverMenu", "straightenYUVs", "defaultText singleLineText defaultButton shortcut", {
        text: "Straighten Y",
        tags: {
            shortcut: "Y"
        },
    ...
    UI.createElement("div", "uvRightClickMenu", "markSeams", "defaultText singleLineText defaultButton shortcut", {
        text: "Mark Seams",
        tags: {
            shortcut: "K"
        },
    ...
    UI.createElement("div", "uvRightClickMenu", "removeSeams", "defaultText singleLineText defaultButton shortcut", {
        text: "Remove Seams",
        tags: {
            shortcut: "O"
        },
    ...
    UI.createElement("div", "uvRightClickMenu", "unwrapSelected", "defaultText singleLineText defaultButton shortcut", {
        text: "Unwrap",
        tags: {
            shortcut: "U"
        },
