...
@fragment fn fragmentMain(
    ...
    output.colour = vec4f(textureColour);
...
const shaderName = "texturedMeshRenderShader"

export const texturedMeshRenderShaderInfo: renderShaderInfo = {
    loadPipeline: () => {
    ...
    render: (commandEncoder, loadOp, properties) => {
        ...
        renderPass.setBindGroup(1, bindGroupManager.getGroup(`${properties["texture"]}BindGroup`))
