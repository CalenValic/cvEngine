...
export class quaternion {
    ...
    static add(q1: quaternion, q2: quaternion, dst?: quaternion): quaternion {
    ...
    static subtract(q1: quaternion, q2: quaternion, dst?: quaternion): quaternion {
        dst = dst || new quaternion()
    ...
    static multiply(q1: quaternion, q2: quaternion, dst?: quaternion): quaternion {
        dst = dst || new quaternion()
    ...
    static scalarMultiply(q: quaternion, scalar: number, dst?: quaternion): quaternion {
        dst = dst || new quaternion()
    ...
    static exp(q: quaternion, dst?: quaternion): quaternion {
        dst = dst || new quaternion()
    ...
    static log(q: quaternion, dst?: quaternion): quaternion {
        dst = dst || new quaternion()
    ...
    static pow(q: quaternion, power: number, dst?: quaternion): quaternion {
        dst = dst || new quaternion
    ...
    static slerp(q1: quaternion, q2: quaternion, t: number, dst?: quaternion): quaternion {
        dst = dst || new quaternion()
    ...
    value: Float32Array = new Float32Array([1, 0, 0, 0])
    ...
    get wxyz(): [number, number, number, number] {
    ...
    set wxyz(wxyz: [number, number, number, number]) {
        this.value[0] = wxyz[0]
        this.value[1] = wxyz[1]
        this.value[2] = wxyz[2]
        this.value[3] = wxyz[3]
    ...
    conjugate(dst?: quaternion): quaternion {
        dst = dst || new quaternion()
    ...
    vectorMultiply(v: vec3, dst?: vec3): vec3 {
    ...
    setRotationMatrix(m: mat4): quaternion {
    ...
    setAxisAngle(axis: vec3, angle: number): quaternion {
    ...
    setEulerAngles(x: number, y: number, z: number): quaternion {
    ...
    rotateAxisAngle(axis: vec3, angle: number): quaternion {
    ...
    lookAt(srcPoint: vec3, dstPoint: vec3, up: vec3): quaternion {
