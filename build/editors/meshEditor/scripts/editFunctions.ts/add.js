...
export const addVertex = (id, position, normal) => {
    ...
    if (normal != undefined) {
        meshData.normals[normal].vertices.add(id);
    }
    return meshData.vertices[id];
};
export const addEdge = (id, vertices) => {
    meshData.edges[id] = {
...
export const addTriangle = (id, vertices, edges) => {
